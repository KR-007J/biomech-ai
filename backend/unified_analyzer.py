...
from analytics_engine import TimeSeriesAnalyzer, ComparativeAnalyticsEngine, MovementSignatureGenerator
from reports_generator import ReportGenerator, ReportConfig
from multi_person_tracker import MultiPersonTracker, PersonReIdentificationEngine, GroupExerciseAnalyzer
    ...
    async def analyze_frame(
        ...
        try:
            ...
            if action_type != ExerciseType.UNKNOWN:
                ...
                result["form"] = {
                    "quality_score": float(form_score),
                    "issues": issues
                }
