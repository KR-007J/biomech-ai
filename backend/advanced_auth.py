        ...
        self.roles = {
            ...
            Role.ADMIN: RoleDefinition(
                ...
                permissions={
                    ...
                    Permission.READ_SESSIONS, Permission.WRITE_SESSIONS,
                    Permission.MANAGE_ROLES, Permission.VIEW_ANALYTICS,
            ...
            Role.TRAINER: RoleDefinition(
                ...
                permissions={
                    Permission.READ_SESSIONS, Permission.WRITE_SESSIONS,
                    Permission.READ_USERS, Permission.VIEW_ANALYTICS,
...
class AuthenticationService:
    ...
    async def register_user(self, username: str, email: str, password: str, 
                           role: str = "athlete", tenant_id: str = None) -> Dict[str, Any]:
        """
        Register new user
    ...
    async def _create_token(self, user_id: str, tenant_id: str, token_type: TokenType,
                           ip_address: Optional[str], ttl_seconds: int) -> JWT:
        """Create JWT token"""
    ...
    async def create_api_key(self, user_id: str, name: str, 
                            permissions: List[str], expires_in_days: int = 365) -> Dict[str, Any]:
        """
    ...
    async def _audit_log(self, user_id: str, action: str, resource: str, status: str, 
                        ip_address: str = None):
