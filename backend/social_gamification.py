...
class SocialGamificationEngine:
    ...
    async def get_leaderboard(self, leaderboard_type: str = "global", 
                             metric: str = "total_reps", period: str = "weekly",
    ...
    async def create_challenge(self, user_id: str, name: str, target_value: float,
                              metric: str, difficulty: str = "medium", 
    ...
    async def unlock_achievement(self, user_id: str, category: str, 
